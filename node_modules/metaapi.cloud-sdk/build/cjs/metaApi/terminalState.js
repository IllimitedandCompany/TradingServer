...
let TerminalState = class TerminalState extends _synchronizationListener.default {
   ...
   */ async refreshTerminalState(options) {
        ...
        callData.promise.timeout(1000 * ((_options_timeoutInSeconds = (_options = options) === null || _options === void 0 ? void 0 : _options.timeoutInSeconds) !== null && _options_timeoutInSeconds !== void 0 ? _options_timeoutInSeconds : 10), "refreshing terminal state timed out");
        try {
